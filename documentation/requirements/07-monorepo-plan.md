...
### Step 3 — `packages/contract` *(Dev A — this is the Day-1 pairing output landing as code)*
...
### Step 4 — `packages/emitter` skeleton *(Dev A)*
...
### Step 10 — Full compose + env *(Dev A, closes E0)*
